...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        'middleware' => ['web','throttle:60,1', InitializeTenancyByDomain::class],                                 // Example: 'throttle:5,1'            | Default: 'throttle:60,1'
    ...
    */
    ...
    'payload' => [
        'max_size' => 10240 * 10240,   // 1MB - maximum request payload size in bytes
